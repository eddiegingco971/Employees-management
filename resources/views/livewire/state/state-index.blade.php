                            ...
                            <div class="form-row align-items-center">
                                <div class="col">
                                    <input type="search" wire:model="search" class="form-control mb-2"
                                        id="inlineFormInput" placeholder="Bohol">
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        @if ($editMode)
                            <h5 class="modal-title" id="stateModalLabel">Edit Province</h5>
                        @else
                            <h5 class="modal-title" id="stateModalLabel">Create Province</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        @if ($editMode)
                            <button type="button" class="btn btn-primary" wire:click="updateState">
                                Update</button>
                        @else
                            <button type="button" class="btn btn-primary" wire:click="storeState">
                                Store</button>
                        @endif
                    </div>
                </div>
